"""
This module provides functions to load a Siamese network model from checkpoints, including handling different checkpoint formats and extracting training information. It also includes utilities to list available checkpoints and their details.
"""
...
def load_model(path, device):
   ...
   # Check the format of the checkpoint
